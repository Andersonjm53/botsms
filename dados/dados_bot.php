...
// TOKEN DO BOT
define ('TOKEN_BOT', '7427978675:AAE_pGlYa78j0V7XJOUykUvzihz6HH4R2ao');

// API KEY https://sms-activate.ru/en/api2
define ('KEY_SMS', 'B4733c977c4c71656f6926f621e53B4d');



define ('RECARGA_MINIMA', '10');
...
define ('CANCELAMENTO_MINIMO', 30); // quantidae minima de cancelamentos DO MESMO SERVIÇO para bloquear um usuário
...
define ('BONUS_AFILIADO', 10); // 15% do valor de recarga do indicado
